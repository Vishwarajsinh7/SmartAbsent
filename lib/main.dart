...
import 'package:flutter_application_1/screen/absentMessage.dart';
import 'package:flutter_application_1/screen/local_cloud_backup.dart';
import 'package:flutter_application_1/screen/recordandreport.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        currentIndex:
            _selectedIndex, // This tells the bar which tab to highlight.
