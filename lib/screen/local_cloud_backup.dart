              ...
              itemBuilder: (context, index) {
                ...
                return FileRow(
                  ...
                  onOnlineChanged: (value) =>
                      setState(() => file.isOnline = value!),
                  onOfflineChanged: (value) =>
                      setState(() => file.isOffline = value!),
                );
              },
            ),
          ],
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          SizedBox(
            width: 60,
            child: Checkbox(value: file.isOnline, onChanged: onOnlineChanged),
          ),
          SizedBox(
            width: 60,
            child: Checkbox(value: file.isOffline, onChanged: onOfflineChanged),
          ),
        ],
      ),
    );
